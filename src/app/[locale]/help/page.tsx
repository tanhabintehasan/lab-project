...
const faqSectionsData = [
  { titleKey: 'sectionPlatform', items: [
...
export default function HelpPage() {
  ...
  const faqSections = faqSectionsData.map(section => ({
    ...section,
    title: t(section.titleKey as 'sectionPlatform'),
  }));
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-indigo-800 text-white py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8">{t('faq')}</p>
          <SearchInput placeholder={t('searchPlaceholder')} onSearch={setSearch} size="lg" className="max-w-xl mx-auto" />
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('noAnswer')}</h2>
          <p className="text-gray-500 mb-6">{t('contactTeam')}</p>
          <div className="flex items-center justify-center gap-4">
            <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">
              <MessageSquare className="h-4 w-4" />{t('onlineConsult')}
            </Link>
            <a href={`tel:${t('phone')}`} className="inline-flex items-center gap-2 px-6 py-3 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium">
