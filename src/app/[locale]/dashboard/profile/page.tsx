...
export default function ProfilePage() {
  ...
  const handleAvatarUpload = (files: { url: string }[]) => {
    if (files.length > 0) {
  ...
  const avatarUrl = (profile?.avatar as string) || '';
    ...
    <DashboardLayout>
      <div className="max-w-2xl space-y-6">
        ...
        <Card padding="lg">
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">更换头像</label>
            <FileUpload
              accept="image/*"
              folder="avatars"
              entityType="avatar"
