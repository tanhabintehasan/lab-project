    ...
    switch (formData.type) {
      ...
      case 'EMAIL':
        return (
          <>
            <div>
              <label className="block text-sm font-medium mb-1">邮件服务商 *</label>
              <select
              ...
              >
                ...
                <option value="console">Console (开发调试)</option>
                  ...
                  <div className="flex items-end pb-2">
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => setFormData({ ...formData, config: { ...formData.config, secure: e.target.checked } })}
                        className="w-4 h-4"
                      />
                      <span className="text-sm font-medium">使用 SSL/TLS</span>
                    </label>
                  </div>
                </div>
                <div>
                  ...
                  <input
                    type="text"
                    value={(formData.config.user as string) || ''}
                    onChange={(e) => setFormData({ ...formData, config: { ...formData.config, user: e.target.value } })}
                    className="w-full border rounded-lg px-3 py-2"
                  />
                </div>
                <div>
                  ...
                  <input
                    type="password"
                    value={(formData.config.pass as string) || ''}
                    onChange={(e) => setFormData({ ...formData, config: { ...formData.config, pass: e.target.value } })}
                    className="w-full border rounded-lg px-3 py-2"
                  />
                </div>
              </>
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, apiKey: e.target.value })}
                    className="w-full border rounded-lg px-3 py-2"
                    placeholder={formData.provider === 'resend' ? 're_xxxxxxxx' : 'SG.xxxxxxxx'}
                    required
                  />
                </div>
              </>
