...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const menuItems = [
    ...
    { href: '/dashboard/orders', icon: ShoppingCart, label: t('myOrders') },
    { href: '/dashboard/quotations', icon: FileQuestion, label: t('myQuotations') },
    { href: '/dashboard/samples', icon: Package, label: t('sampleTracking') },
    { href: '/dashboard/reports', icon: FileText, label: t('testReports') },
    { href: '/dashboard/bookings', icon: CalendarDays, label: t('equipmentBooking') },
    { href: '/dashboard/wallet', icon: Wallet, label: t('walletCenter') },
    { href: '/dashboard/referral', icon: Users, label: t('referral') },
    { href: '/dashboard/messages', icon: MessageSquare, label: t('notifications') },
    { href: '/dashboard/profile', icon: User, label: t('profile') },
    { href: '/dashboard/settings', icon: Settings, label: t('accountSettings') },
  ];
    ...
    >
      <div className="h-16 flex items-center px-4 border-b border-gray-200">
        <Link href="/" className="flex items-center gap-2">
          ...
          {!collapsed && <span className="font-bold text-gray-900">{t('title')}</span>}
        </Link>
      </div>
